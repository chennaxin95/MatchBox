...
public class AidenModel extends CharacterModel {
	...
	public AidenModel(float x, float y, float width, float height,
		...
		trailLeft.load(Gdx.files.internal("platform/left.p"), Gdx.files.internal("platform"));
		trailRight = new ParticleEffect();
		trailRight.load(Gdx.files.internal("platform/right.p"), Gdx.files.internal("platform"));
		trailStill = new ParticleEffect();
		trailStill.load(Gdx.files.internal("platform/still.p"), Gdx.files.internal("platform"));
		trailStill.start();
		trailRight.start();
		trailLeft.start();
	}
...
//		}
	...
	public void draw(GameCanvas canvas) {
		...
		trailLeft.setPosition(getX()*drawScale.x, (getY()-0.5f)*drawScale.y);
		trailRight.setPosition(getX()*drawScale.x, (getY()-0.5f)*drawScale.y);
		trailStill.setPosition(getX()*drawScale.x, (getY()-0.5f)*drawScale.y);
